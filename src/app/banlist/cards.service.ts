...
export class CardsService{
  cards: Array<Card> = [
    new Card('Banned', 'Yata-Garasu', 'Effect Monster'),
		new Card('Banned', 'Change of Heart', 'Spell Card'),
		new Card('Banned', 'Dark Hole', ' Spell Card'),
		new Card('Banned', 'Giant Trunade', 'Spell Card'),
		new Card('Banned', 'Raigeki', 'Spell Card'),
		new Card('Banned', 'Imperial Order', 'Trap Card'),
		...
		new Card('Limited', 'Pot of Greed', 'Spell Card'),
